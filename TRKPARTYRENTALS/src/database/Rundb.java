...
public class Rundb {
	...
	public static void main(String[] args) {
		...
		//trkconnect.AddUser("Rodje", "Ross", "djeross", "uwimona", "developer");
		//trkconnect.Add_Equipment("chX1024", "Chair",100);
		//trkconnect.removeUser("");
		//System.out.println(trkconnect.userPasswordValidation("marmck", "cavehill"));
		//trkconnect.View_Equipment_Info("chX1024");
		//trkconnect.Add_Equipment("spX0032", "Stripper Pole",5);
